<template>
  <div
    class="min-h-screen bg-gradient-to-br from-emerald-200 via-green-100 to-white flex items-center justify-center px-4 py-10"
  >
    <div
      class="w-full max-w-md bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl border border-white/40 p-8 relative"
    >
      <!-- Botão voltar -->
      <button
        @click="voltar"
      ...
      <div class="text-center mb-8">
        ...
        <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Criar Conta</h1>
        <p class="text-sm text-gray-500 mt-1">Preencha os dados para começar</p>
      </div>
      ...
      <form @submit.prevent="cadastrarUsuario" class="space-y-5">
        ...
        <div>
          ...
          <input
            ...
            class="w-full rounded-xl border px-4 py-3 text-sm focus:outline-none focus:ring-2 transition"
            :class="
              emailInvalido
