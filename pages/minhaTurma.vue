<template>
  <div class="min-h-screen bg-gray-50 p-8">
    ...
    <div v-else class="space-y-6">
      ...
      <div class="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
        <p
          class="text-xs text-gray-400 font-semibold uppercase tracking-wide mb-5"
        >
          Sua posição na turma
        </p>
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="flex-1 min-w-0">
            <p class="text-lg font-bold text-gray-800">
              {{ minhaPosicao.posicao }}º de {{ rankingAtivos.length }}
            </p>
            <p
      ...
      >
        ...
        >
          Nenhuma aula realizada ainda. O ranking aparecerá assim que houver
          ...
          >
            ...
            <div class="flex-1 min-w-0">
              <p class="text-sm font-semibold text-gray-800 truncate">
                ...
                <span
                  v-if="aluno.isVoce"
                  class="ml-1 text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full font-medium"
                  >você</span
                >
              </p>
              <!-- Barra de frequência -->
            ...
            <div class="text-right flex-shrink-0">
              ...
              <p class="text-xs text-gray-400">
                {{ aluno.presencas }}/{{ aulasRealizadas }}
              </p>
            </div>
          </li>
        </ul>
        ...
        >
          <p class="text-xs text-gray-400">
            + {{ inativos.length }} aluno(s) inativo(s) não exibido(s) no
            ranking
          </p>
        </div>
      </div>
