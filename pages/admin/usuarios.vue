      ...
      <table class="w-full text-sm">
        <thead>
          <tr class="bg-gray-50 border-b border-gray-100">
            ...
            <th
              class="text-center px-6 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wide"
            >
              Tipo
            </th>
            <th
            ...
            <td class="px-6 py-4 text-center">
              <div class="flex items-center justify-center gap-2">
                <button
                  ...
                  class="text-xs px-3 py-1.5 rounded-lg bg-gray-100 text-gray-600 hover:bg-gray-200 transition font-semibold"
                >
                  ✏️ Editar
                </button>
                <button
      ...
      >
        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          <div>
            ...
            />
            <p v-if="modo === 'editar'" class="text-xs text-gray-400 mt-1">
          ...
          <div v-if="modo === 'criar'">
            ...
            <div class="flex gap-2">
              ...
              >
                ...
                <option
                  v-for="opcao in ['ALUNO', 'PROFESSOR', 'ADMIN'].filter(
                    (o) => !papeisCriacao.includes(o),
                  )"
                  :key="opcao"
                  :value="opcao"
                >
          ...
          <div v-if="modo === 'editar'">
            ...
            <div class="flex flex-wrap gap-2 mb-3">
              ...
              <span
                v-if="papeisUsuario.filter((p) => p.ativo).length === 0"
                class="text-xs text-gray-400"
              >
                Nenhum papel ativo.
              </span>
            ...
            <div class="flex gap-2">
              ...
              >
                ...
                <option
                  v-for="opcao in ['ALUNO', 'PROFESSOR', 'ADMIN'].filter(
                    (o) => !papeisUsuario.some((p) => p.papel === o && p.ativo),
                  )"
                  :key="opcao"
                  :value="opcao"
                >
...
async function adicionarPapel(papel) {
  ...
  if (existente && !existente.ativo) {
    ...
    await supabase
      .from("usuario_papel")
      .insert({ usuario_id: usuarioEditando.value.id, papel, ativo: true });
  }
