    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      >
        ...
        <p class="text-gray-500 text-sm leading-relaxed">
          Visualize sua frequência nas aulas e acompanhe seu percentual de presença.
        </p>
      ...
      >
        ...
        <p class="text-gray-500 text-sm leading-relaxed">
          Registre sua presença na aula de hoje escaneando o QR Code disponibilizado pelo professor!
        </p>
      ...
      <div
        ...
        @click="irPara('/presencaProfessor')"
        class="group bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:border-green-500 transition-all duration-300 cursor-pointer"
      >
        <div class="flex justify-between items-center mb-4">
          <h2 class="text-lg font-semibold text-gray-800 group-hover:text-green-700 transition">
        ...
        <p class="text-gray-500 text-sm leading-relaxed">
          Gerencie suas turmas, visualize alunos e acompanhe a presença semanal.
        </p>
      ...
      >
        ...
        <p class="text-gray-500 text-sm leading-relaxed">
          Atualize seus dados pessoais, e-mail e informações da conta.
        </p>
