<template>
  <div class="min-h-screen bg-gray-50 p-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div
        v-if="isAluno"
        @click="irPara('/aluno/turmas?destino=minha-presenca')"
      ...
      <div
        v-if="isAluno"
        @click="irPara('/aluno/turmas?destino=minha-turma')"
        class="group bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:border-green-500 transition-all duration-300 cursor-pointer"
      >
        <div class="flex justify-between items-center mb-4">
          <h2
      ...
      <div
        v-if="isAluno"
        @click="irPara('/aluno/turmas?destino=minhas-atividades')"
        class="group bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:border-green-500 transition-all duration-300 cursor-pointer"
      >
        <div class="flex justify-between items-center mb-4">
          <h2
        ...
        <p class="text-gray-500 text-sm leading-relaxed">
          Veja suas notas, participações e feedbacks.
        </p>
        <div
          class="mt-6 text-green-600 font-medium text-sm group-hover:translate-x-1 transition"
        >
      ...
      <div
        v-if="isAdmin"
        @click="irPara('/admin/cadastro-lote')"
        class="group bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:border-green-500 transition-all duration-300 cursor-pointer"
      >
        <div class="flex justify-between items-center mb-4">
          <h2
        ...
        <p class="text-gray-500 text-sm leading-relaxed">
          Cadastre inúmero usuários de uma vez só, apenas importando um arquivo
          .csv.
        </p>
        <div
          class="mt-6 text-green-600 font-medium text-sm group-hover:translate-x-1 transition"
      ...
      >
        <div class="flex justify-between items-center mb-4">
          ...
          <span
            v-if="pendentes > 0"
            class="text-xs bg-red-500 text-white px-3 py-1 rounded-full font-semibold"
          >
            {{ pendentes }} pendente(s)
          </span>
          <span
      ...
      <div
        v-if="isAdmin"
        @click="irPara('/admin/configuracoes')"
        class="group bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-xl hover:border-green-500 transition-all duration-300 cursor-pointer"
      >
        <div class="flex justify-between items-center mb-4">
          <h2
